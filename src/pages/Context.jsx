  ...
  return (
    <BrowserSizedContainer>  
      ...
      <TextContainer style={{textAlign: 'center'}}>
        ...
        <span>Ce parcours permet ainsi de traverser différentes strates temporelles de la ville, que l’on peut regrouper en trois grandes périodes. L’ancien, tout d’abord, désigne les formes urbaines antérieures au XIXe siècle : quartiers médiévaux, tracés étroits, patrimoine architectural ancien souvent centré autour d’un noyau historique. Vient ensuite la période moderne, qui s'étend de l’haussmannisation du XIXe siècle aux grands mouvements du XXe siècle tels que le modernisme et les principes formulés par les CIAM. Enfin, la période contemporaine, amorcée au XXIe siècle, se caractérise par une approche plus sensible et durable de l’aménagement urbain. Elle intègre les notions de mixité, d’écologie, de réversibilité des usages et redonne une place centrale à l’habitant, à la culture comme le street art et à l’expérience du paysage urbain.</span>
